...
from .models import User, Menu, Module, GroupModulePermission, SystemConfig
...
class SystemConfigAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Información General', {'fields': ('name', 'description', 'company', 'year')}),
        ('Apariencia', {'fields': ('icon', 'logo')}),
    )
